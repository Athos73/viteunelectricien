/**
 * Le design Stitch s'appuie sur la police Material Symbols. Charger une police
 * d'icônes entière pour huit glyphes coûterait plus cher que tout le HTML d'une
 * page de commune : on inline les tracés à la place.
 */
const TRACES = {
  eclair:
  ...
  lieu: "M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5a2.5 2.5 0 0 1 0-5 2.5 2.5 0 0 1 0 5z",
  coche:
...
/** Icône décorative : masquée aux lecteurs d'écran, le texte porte le sens. */
